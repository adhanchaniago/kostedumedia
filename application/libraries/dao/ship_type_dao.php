...
class ship_type_dao extends Generic_dao {
    ...
    public function field_map() {
        return array('shiptype_id' => 'shiptype_id', 'shiptype_desc' => 'shiptype_desc','shiptype_icon'=>'shiptype_icon');
    }
...
//        $this->ci->db->where("ship.shiptype_id = '" . $keys['shiptype_id'] . "'");
//
