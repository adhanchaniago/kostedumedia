<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#cancelBtn').click(function(){
			window.location = '<?php echo base_url()?>admin/logistic_item_ctrl'
		});
	});
...
<div class="span12 block">			
	<div class="block_head">
		...
		<h2>logistic_item Data Editor</h2>
	</div>		<!-- .block_head ends -->		
	...
	<div class="block_content">
				<form action="<?php echo base_url()?>admin/logistic_item_ctrl/save" method="post">
					<p>
...
<p>
						<label>log_item_desc * </label><br/>
						<input name="log_item_desc" type="text"
						value="<?php if(!empty($obj)) echo $obj->log_item_desc; ?>" <?php if(!empty($obj)) echo 'readonly'?>>
						<?php echo form_error('log_item_desc');?>					</p>
