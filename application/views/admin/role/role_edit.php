...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#cancelBtn').click(function(){
			window.location = '<?php echo base_url()?>admin/role_ctrl'
		});
	});
</script>
...
<div class="span12 block">			
	...
	<div class="block_content">
				<form action="<?php echo base_url()?>admin/role_ctrl/save" method="post">
					<p>
...
<p>
						<label>role_name * </label><br/>
						<input name="role_name" type="text"
						value="<?php if(!empty($obj)) echo $obj->role_name; ?>" <?php if(!empty($obj)) echo 'readonly'?>>
						<?php echo form_error('role_name');?>					</p>
