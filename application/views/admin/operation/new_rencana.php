    ...
    <ul class="form-admin">
        ...
        <li>
            <div class="select-ops">
                <p>Tersedia</p>
                <ul>
                    <li><label><input type="checkbox"> KRI 1</label></li>
                    <li><label><input type="checkbox"> KRI 2</label></li>
                    <li><label><input type="checkbox"> KRI 3</label></li>
                    <li><label><input type="checkbox"> KRI 1</label></li>
                    <li><label><input type="checkbox"> KRI 2</label></li>
                    <li><label><input type="checkbox"> KRI 3</label></li>
                    <li><label><input type="checkbox"> KRI 1</label></li>
            ...
            <div class="select-ops">
                <p>Ikut Operasi</p>
                <ul>
                    <li><label>KRI 1</label></li>
                    <li><label> KRI 2</label></li>
                    <li><label><input type="checkbox"> KRI 3</label></li>
                    <li><label><input type="checkbox"> KRI 1</label></li>
                    <li><label><input type="checkbox"> KRI 2</label></li>
                    <li><label><input type="checkbox"> KRI 3</label></li>
