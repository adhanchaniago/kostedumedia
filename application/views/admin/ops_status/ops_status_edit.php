<script type="text/javascript">
	$(document).ready(function(){
		...
		$('#cancelBtn').click(function(){
			window.location = '<?php echo base_url()?>admin/ops_status_ctrl'
		});
	});
</script>
...
<div class="span12 block">			
	...
	<div class="block_content">
				<form action="<?php echo base_url()?>admin/ops_status_ctrl/save" method="post">
					<p>
						<label>Operation Status ID * </label><br/>
...
<p>
						<label>Operation Status Description * </label><br/>
						<input name="ops_stat_desc" type="text"
						value="<?php if(!empty($obj)) echo $obj->ops_stat_desc; ?>" <?php if(!empty($obj)) echo 'readonly'?>>
						<?php echo form_error('ops_stat_desc');?>					</p>
