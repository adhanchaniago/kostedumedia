...
class fight_vehicle_logistic_ctrl extends CI_Controller {

    public $data;
    public $filter;
    public $limit = 16;
    public static $CURRENT_CONTEXT = '/admin/fight_vehicle_logistic_ctrl';
    ...
    private function validate() {
        ...
        $this->form_validation->set_rules('fvehicle_value', 'fvehicle_value', '');
    ...
    public function index($offset = 0) {
        ...
        $this->load_view('admin/fight_vehicle_logistic/list_fight_vehicle_logistic', $this->data);
    }

    public function fetch_record($keys) {
        $this->data['fight_vehicle_logistic'] = $this->fight_vehicle_logistic_dao->by_id($keys);
    }

    private function fetch_data($limit, $offset) {
        $this->data['fight_vehicle_logistic'] = $this->fight_vehicle_logistic_dao->table_fetch($limit, $offset);
    ...
    private function fetch_input() {
        $data = array('logitem_id' => $this->input->post('logitem_id'),
            ...
            'fvehicle_value' => $this->input->post('fvehicle_value'));
    ...
    public function save() {
        ...
        if ($this->validate() != false) {
            ...
            if ($this->fight_vehicle_logistic_dao->by_id($obj_id) != null) {
                $this->fight_vehicle_logistic_dao->update($obj, $obj_id);
            } else {
                $this->fight_vehicle_logistic_dao->insert($obj);
            }
     ...
     */
    public function edit($logitem_id = null, $fv_id = null) {
        if ($logitem_id == null || $fv_id == null
        ) {
            $this->load_view('admin/fight_vehicle_logistic/fight_vehicle_logistic_edit');
        } else {
            $param = $this->get_list($this->limit);
            $obj_id = array('logitem_id' => $logitem_id, 'fv_id' => $fv_id);

            $to_edit = $this->fight_vehicle_logistic_dao->by_id($obj_id);
     ...
     */
    public function view($logitem_id = null, $fv_id = null) {
    ...
    public function delete($logitem_id = null, $fv_id = null) {
        $obj_id = array('logitem_id' => $logitem_id,
            'fv_id' => $fv_id);
